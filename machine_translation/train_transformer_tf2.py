...
class Encoder(tf.keras.Model):
    def __init__(self, vocab_size, model_size, num_layers, h):
        ...
        self.attention = [MultiHeadAttention(model_size / h, model_size / h, model_size) for _ in range(num_layers)]
...
class Decoder(tf.keras.Model):
    def __init__(self, vocab_size, model_size, num_layers, h):
        ...
        self.h = h
        self.embedding = tf.keras.layers.Embedding(vocab_size, model_size)
        self.attention_bot = [MultiHeadAttention(model_size / h, model_size / h, model_size) for _ in range(num_layers)]
        self.attention_mid = [MultiHeadAttention(model_size / h, model_size / h, model_size) for _ in range(num_layers)]
